...
var Game = {
    ...
    draw: function () {
        ...
        this.context.fillStyle = 'yellow';  // For players
        ...
        // Set the fill style to green for the AI paddle
        this.context.fillStyle = 'white'; // Green color for the AI paddle
        ...
        this.context.lineWidth = 12; // Increase the line width for a bold line
        ...
        this.context.fillRect(0, (this.canvas.height / 2) - 50, 40, 200); // Adjust dimensions and position as needed (width, height)

        // Right goal post
        this.context.fillRect(this.canvas.width - 40, (this.canvas.height / 2) - 50, 40, 200); // Adjust dimensions and position as needed
